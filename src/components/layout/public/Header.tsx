        ...
        >
          {routes.map((route) => (
            <Link
              key={route.name}
              href={route.url}
              className={`rounded-full px-4 py-2.5 text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
                isActive(route.url)
